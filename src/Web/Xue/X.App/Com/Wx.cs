...
namespace X.App.Com
{
    public class Wx
    {
        ...
        public class Pay
        {
            public static Oxml MdOrder(string body, string order_no, string total, string notify_url, string appid, string mch_id, string mch_key)
            {
