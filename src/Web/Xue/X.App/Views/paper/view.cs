...
namespace X.App.Views.paper {
    public class view : _web {
        ...
        protected override void InitDict() {
            ...
            ////题型
            //var ques = DB.x_question.Where(o => ids.Keys.Contains(o.question_id + "")).OrderBy(o => o.ctime).ToList().Select(o => o.topic==1);
            //var ss = GetDictName("question.topic", ques);
            //var json1 = Context.Server.UrlDecode(ss+"");
            ...
            var paps = DB.x_paper.Where(o => o.book == paper.book&&o.user_id==null).OrderByDescending(o=>o.mtime).Take(10);
            dict.Add("paps", paps);
